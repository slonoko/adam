...
cashanova_agent = create_agent(
    ...
    system_prompt=prompt.CASHANOVA_INSTRUCTION
)

datetime_agent = create_agent(
    model=llm,
    tools=datetime_tool,
    system_prompt=prompt.TIMEKEEPER_INSTRUCTION
)

stocks_data_agent = create_agent(
    model=llm,
    tools=stocks_data_tool,
    system_prompt=prompt.STOCKWHISPERER_INSTRUCTION
)

news_agent = create_agent(
    model=llm,
    tools=news_tool,
    system_prompt=prompt.FRESHNEWS_INSTRUCTION
)
